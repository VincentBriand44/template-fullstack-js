...
4. Adapt _database.sql_ with your own tables. Import the script in your SQL server. You can do it manually or run _migrate_ script (either using `yarn run migrate`).
5. Start the server in dev mode with `yarn run dev`. This will run `index.js` using _nodemon_.
